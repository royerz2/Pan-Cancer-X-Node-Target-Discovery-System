...
BENCHMARK = {
    ...
    # Testable-only (35/43 entries with DepMap >=5 lines AND all targets Phase 2+ druggable)
    "n_testable": 35,
    "n_untestable": 8,
    "alin_testable_any_overlap": 54.3,
    "alin_testable_pair_overlap": 37.1,
    "driver_testable_any_overlap": 54.3,
    "driver_testable_pair_overlap": 20.0,
    "global_freq_testable_any_overlap": 60.0,
    "global_freq_testable_pair_overlap": 34.3,
    "random_testable_any_overlap": 27.1,
    "random_testable_pair_overlap": 10.7,
    # Cancer-level precision
    "alin_precision": 47.1,
    "alin_precision_testable": 47.1,
    "alin_precision_evaluable": 17,
    "alin_precision_hits": 8,
    "alin_precision_evaluable_testable": 17,
    "alin_precision_hits_testable": 8,
    "global_freq_precision": 58.8,
    "global_freq_precision_testable": 58.8,
    "driver_precision": 100.0,
    "driver_precision_testable": 100.0,
    "random_precision": 34.0,
    "random_precision_testable": 34.1,
    ...
    "cpool_random_testable_any_overlap": 0.2,
    "cpool_random_testable_pair_overlap": 0.0,
    "cpool_random_precision": 0.4,
    "cpool_random_precision_testable": 0.3,
    ...
    "noks_exact": 7.0,
    "noks_precision": 47.1,
    "noks_precision_testable": 47.1,
    "noks_testable_any_overlap": 54.3,
